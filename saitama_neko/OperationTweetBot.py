...
class OperationTweetBot():
    ...
    def tweet(self):
        ...
        self.client.create_tweet(text = SaitamaSeCats.CreateSentens('n').create_2())
...
if __name__ == '__main__':
    ...
    OperationTweetBot(CONSUMER_KEY,CONSUMER_SECRET,BEARER_TOKEN,ACCESS_TOKEN,ACCESS_SECRET).tweet()